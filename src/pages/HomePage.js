  ...
  return (
    <div className="homePage">
      <div className="layout_center">
        <ImageSlider data={imageSlider1Data} settings={imageSlider1Settings} />
      </div>
      <div className="layout_center">
            ...
            <div aria-live="polite" className="slick-list draggable">
              ...
              >
                ...
                >
                  ...
                  <p>
                    Good Seller. Seeds haven't sow yet but buying experience was
                    satisfactory. Delievery and response was perfect. No regret
                    and hoping that plant come out when I saw it.
                  </p>
