    ...
    return (
      <Layout showFooter={true} showHeader={true} showCart={true}>
        ...
        <div className="profile-page">
          {editShow || editAddressData || showAddress ? (
            <>
              {editShow && <EditUserInfo />}
              {editAddressData && <EditAddress />}
              {showAddress && <AddAddress />}
            </>
          ) : (
            <>
              <div className="say-hello">
                ...
                <p style={{ textAlign: "center" }}>
                  This is your profile page. You can see and edit your details
                  here.
                </p>
                <button
                    ...
                    <div>
                      {addresses.length > 0 ? (
                        addresses.map((address, index) => {
                          const { id, address1, city, country, zip } =
                            address.node;
                              ...
                              <div className="header">
                                ...
                                <div>
                                  <i
                                    ...
                                    className="icons"
                                    onClick={() =>
                                      setEditAddressData(address.node)
                                    }
                                  >
                                    <AiFillEdit />
                                  </i>
